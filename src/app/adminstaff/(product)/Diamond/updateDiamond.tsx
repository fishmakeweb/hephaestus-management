import { Carat, Clarity, Color, Cut, Measurement } from "@/dbUtils/diamondAPI/types";
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-6 rounded shadow-md text-center">
                <h2 className="text-xl font-semibold mb-4">Update Diamond Successfully</h2>
                <button
...
const FormUpdateDiamond: React.FC<{ diamondId: any, onClose: () => void }> = ({ diamondId, onClose }) => {
                ...
                <div className="bg-white p-9 rounded shadow-md max-h-screen overflow-y-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.diamondMeasurement && <p className="text-red-500 text-xs">{errors.diamondMeasurement}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.diamondColor && <p className="text-red-500 text-xs">{errors.diamondColor}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.diamondCut && <p className="text-red-500 text-xs">{errors.diamondCut}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.diamondCarat && <p className="text-red-500 text-xs">{errors.diamondCarat}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.diamondClarity && <p className="text-red-500 text-xs">{errors.diamondClarity}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-gray-100 border border-gray-300 rounded px-3 py-2"
                            />
                            {errors.diamondPrice && <p className="text-red-500 text-xs">{errors.diamondPrice}</p>}
                        </div>
